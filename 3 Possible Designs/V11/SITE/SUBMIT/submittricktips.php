...
<?php
   ...
   $message = "Picture info:
	...
	Senders Secret Username = $secret
	Senders e-mail = $fromemail
	senders trick = the $trickname
    $name";
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" 
   ...
   <br><font color="#fbb543">LIMITED OFFER:</font> Secret Username:<br>
   <input type="text" name="secret" size=33 style=" border-color:#6699cc;background-color:003366;color:#f3fe1e;font-size:8pt; font-family:Arial;border-style:dashed;"><br>
   <br>your e-mail:
   ...
   <br>trick explination:
   <br><textarea name="" rows=5 cols=35 style=" border-color:#6699cc;background-color:003366;color:#f3fe1e;font-size:8pt; font-family:Arial;border-style:dashed;" ></textarea><br>
   <br>video or picture file(optional):
