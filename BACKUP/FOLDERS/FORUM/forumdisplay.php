...
if($self['status'] == "Moderator" || $self['status'] =="Super Moderator" || $self['status'] =="Administrator" || $self['status'] =="Super Administrator") {
...
if($forum['mpnp'] != "0" || $forum['mpnt'] != "0" || $forum['mpfa'] != "0"){ $Ffie = ''; $showfi = '';
    ...
    if($forum['mpnp'] != "0"){ $lang['mpnpi'] = str_replace("*posts*", $forum['mpnp'], $lang['mpnpi']); $showfi .= "$Ffie"; $showfi .= $lang['mpnpi']; $Ffie = '<br />'; if($self['postnum'] < $forum['mpnp'] && $self['status'] != "Super Administrator"){ $replylink = ''; } }
